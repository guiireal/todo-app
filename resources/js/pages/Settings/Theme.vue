...
const submit = handleSubmit((values: { theme: "light" | "dark" | "auto" }) => {
  mode.value = values.theme;

  toast({
    title: "Sucesso!",
    description: "Aparência atualizada com sucesso!",
  });
});
</script>
    ...
    <form class="space-y-8" @submit.prevent="submit">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Selecione a aparência para o painel de controle.</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Button type="submit" :disabled="isSubmitting">
        ...
        <span v-if="!isSubmitting">Atualizar</span>
      </Button>
    </form>
  </SettingsLayout>
</template>
